...
pub(crate) use self::{
    ...
    sidebar::{
        agent_panel_body_rect, agent_panel_entries, agent_panel_entry_height,
        agent_panel_scroll_metrics, agent_panel_scrollbar_rect, collapsed_sidebar_toggle_rect,
...
mod tests {
    ...
    fn tab_bar_dims_auto_named_tabs_and_emphasizes_custom_tabs() {
        ...
        assert_eq!(auto_style.fg, Some(app.palette.accent));
